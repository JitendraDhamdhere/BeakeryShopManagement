...
{
    public partial class MemberForgetPassword : Form
    {
        ...
        {
            this.Hide();
            MemberLogin frm = new MemberLogin();
            frm.Show();
        }
        ...
        private bool ValidateEmail()
        {
            try
            {
                ...
                string query = "SELECT Mail FROM UserTable WHERE Mail=@find AND UType='M'";
