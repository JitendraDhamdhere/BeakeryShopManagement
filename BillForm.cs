...
namespace BakeryShopManagement
{
    public partial class BillForm : UserControl
    {
        ...
        private static BillForm _instance;

        public static BillForm Instance
        {
            get
            {
                if (_instance == null)
        ...
        private void AutocompleteSuggestId()
        {
            try
            {
                con = new SqlConnection(cs.DBConn);
                con.Open();
                SqlCommand cmd = new SqlCommand("SELECT ItemName FROM ItemMasterTable", con);
        ...
        private void txtItemName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.CommandText = "SELECT Price from ItemMasterTable WHERE ItemName = '" + txtItemName.Text + "'";
